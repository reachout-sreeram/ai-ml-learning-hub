// Automatically generated AI/ML Quiz data (index: 1095)
export const questions = [
  ...
  },
  {
    ...
    "explanation": "L1 (Lasso) and L2 (Ridge) regularization add penalty terms to the loss function to prevent weight values from becoming too large. (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation)"
  }
];
