// Automatically generated AI/ML Quiz data (index: 739)
export const questions = [
  ...
  },
  {
    ...
    "explanation": "Overfitting occurs when a model fits the noise in the training data and fails to generalize to unseen test data. (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation)"
  }
];
