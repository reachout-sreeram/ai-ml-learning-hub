// Automatically generated AI/ML Quiz data (index: 1053)
export const questions = [
  {
    "question": "What is the primary goal of Supervised Learning?",
    "options": [
      "To find hidden patterns in unlabeled data",
      "To train a model on labeled inputs to predict outcomes",
      "To maximize rewards in a environment",
  ...
  },
  {
    ...
    "explanation": "Boosting methods train models sequentially, with each subsequent model focusing on the residuals/errors of its predecessor. (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation) (clarified validation)"
  }
];
